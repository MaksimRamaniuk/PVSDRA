...
HD_PWD='C:/Users/Public/Documents/PVSDRA/Lab_1/Lab_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mac.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mac.tcl -notrace
