...
HD_PWD='C:/Users/Public/Documents/PVSDRA/Lab_3/Lab_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR.tcl
