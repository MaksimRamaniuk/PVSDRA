...
HD_PWD='C:/Users/Public/Documents/PVSDRA/Lab_3/Lab_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIR.tcl -notrace
