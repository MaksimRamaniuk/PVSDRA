...
HD_PWD='C:/Users/Public/Documents/PVSDRA/Lab_2/Lab_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IIR.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IIR.tcl -notrace
