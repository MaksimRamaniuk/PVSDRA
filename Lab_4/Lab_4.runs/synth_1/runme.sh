...
HD_PWD='C:/Users/Public/Documents/PVSDRA/Lab_4/Lab_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CORDIC_coprocessor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CORDIC_coprocessor.tcl
