...
HD_PWD='C:/Users/Public/Documents/PVSDRA/Lab_4/Lab_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CORDIC_coprocessor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CORDIC_coprocessor.tcl -notrace
